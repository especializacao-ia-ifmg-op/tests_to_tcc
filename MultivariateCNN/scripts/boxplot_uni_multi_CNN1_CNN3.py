...
u_CNN1 = pd.read_csv('./results/u_results_CNN1_old.csv',delimiter=',')
u_CNN1 = u_CNN1[u_CNN1['Unnamed: 0'].isin([0,2,6,9])]

u_CNN3 = pd.read_csv('./results/u_results_CNN3_old.csv',delimiter=',')
...
m_rs_CNN1 = pd.read_csv('./results/m_rs_results_CNN1_old.csv',delimiter=',')
m_rs_CNN1 = m_rs_CNN1[m_rs_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_u2_CNN1 = pd.read_csv('./results/m_u2_results_CNN1_old.csv',delimiter=',')
m_u2_CNN1 = m_u2_CNN1[m_u2_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_rh_CNN1 = pd.read_csv('./results/m_rh_results_CNN1_old.csv',delimiter=',')
m_rh_CNN1 = m_rh_CNN1[m_rh_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_tmax_CNN1 = pd.read_csv('./results/m_tmax_results_CNN1_old.csv',delimiter=',')
m_tmax_CNN1 = m_tmax_CNN1[m_tmax_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_tmin_CNN1 = pd.read_csv('./results/m_tmin_results_CNN1_old.csv',delimiter=',')
m_tmin_CNN1 = m_tmin_CNN1[m_tmin_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_pr_CNN1 = pd.read_csv('./results/m_pr_results_CNN1_old.csv',delimiter=',')
m_pr_CNN1 = m_pr_CNN1[m_pr_CNN1['Unnamed: 0'].isin([0,2,6,9])]

m_rs_u2_CNN1 = pd.read_csv('./results/m_rs_u2_results_CNN1_old.csv',delimiter=',')
