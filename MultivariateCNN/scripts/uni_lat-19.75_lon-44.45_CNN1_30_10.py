...
def form_data(data, t, n_execucoes, n_previsoes):
    ...
    df1 = df.T
    frames = [df1.iloc[:,0], df1.iloc[:,1], df1.iloc[:,2], df1.iloc[:,3], df1.iloc[:,4], df1.iloc[:,5], df1.iloc[:,6], df1.iloc[:,7], df1.iloc[:,8], df1.iloc[:,9], df1.iloc[:,10], df1.iloc[:,11], df1.iloc[:,12], df1.iloc[:,13], df1.iloc[:,14], df1.iloc[:,15], df1.iloc[:,16], df1.iloc[:,17],df1.iloc[:,18], df1.iloc[:,19], df1.iloc[:,20], df1.iloc[:,21], df1.iloc[:,22], df1.iloc[:,23], df1.iloc[:,24], df1.iloc[:,25], df1.iloc[:,26], df1.iloc[:,27], df1.iloc[:,28], df1.iloc[:,29]]
...
# Running the model
print(f'[uni_lat-19.75_lon-44.45_30_10.py]\n')
print(f'Running...')

start = time.time()
run_model(dataset_file_name='uni_lat-19.75_lon-44.45.csv', result_file_name='new_u_results_CNN1_30_10.csv', sufix='1 (ETo)', star=star_CNN1, n_var=1, n_execucoes=30, n_previsoes=10)
stop = time.time()
