...
# Running the model
print(f'[multi_all_lat-19.75_lon-44.45.py]\n')
print(f'Running...')

start = time.time()
run_model(dataset_file_name='multi_all_lat-19.75_lon-44.45.csv', result_file_name='new_m_all_results_CNN1_5_3.csv', sufix='1 (Rs, u2, Tmax, Tmin, RH, pr, ETo)', star=star_CNN1, n_var=7, n_execucoes=5, n_previsoes=3)
stop = time.time()
