...
star_CNN1 = {'filters': 1, 'pool': 1, 'pool_size': 4, 'dropout': 0.7488528907967992, 'norm': 1, 'lags': 1, 'num_conv': 2, 'kernel_size': 3, 'rmse': 0.23124203892843392, 'num_param': 1713}

print(f'[multi_rs_lat-19.74_lon-44.45.py]\n')
print(f'Getting dataset...')
m_row_train, m_row_test = get_search_dataset_multivariate('multi_rs_lat-19.75_lon-44.45.csv', n_var=2)
print(f'...OK!\n')
...
result_file_name = 'm_rs_lat-19.74_lon-44.45_results_CNN1_' + str(n_execucoes) + '_' + str(n_previsoes) + '.csv'
m_rs_results_CNN1.to_csv(result_file_name, index=True)
print(f'Done! Exeution time = {stop - start} s.')