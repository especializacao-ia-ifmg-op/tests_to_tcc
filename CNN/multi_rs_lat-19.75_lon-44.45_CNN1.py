...
# Running the model
print(f'[multi_rs_lat-19.75_lon-44.45.py]\n')
print(f'Running...')

start = time.time()
run_model(dataset_file_name='multi_rs_lat-19.75_lon-44.45.csv', result_file_name='new_m_rs_results_CNN1_5_3.csv', sufix='1 (Rs, ETo)', star=star_CNN1, n_var=2, n_execucoes=5, n_previsoes=3)
stop = time.time()
